        ...
        <form @submit.prevent>
          <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div class="md:col-span-2">
              <label
                for="circle-classification-name"
...
const form = useForm({
  ...
  is_active: props.classification.is_active,
})

function update() {
  form.post(route('admin.circle_classifications.update', props.classification.id), {
    onSuccess: () => success(t('circle_classifications.circleClassificationUpdatedSuccessfully')),
    onError: () => error(t('circle_classifications.circleClassificationUpdateFailed')),
    preserveScroll: true,
  })
}
</script>
