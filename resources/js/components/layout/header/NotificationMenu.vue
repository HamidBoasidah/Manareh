          ...
          >
            ...
            <span class="block">
              <span class="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                ...
                <span class="font-medium text-gray-800 dark:text-white/90">
                  {{ t('notification_messages.project', { name: notification.projectName }) }}
                </span>
              </span>
...
const notifications = ref([
  {
    ...
    actionKey: 'notification_messages.requestsPermission',
    projectName: 'Nganter App',
    typeKey: 'notification_messages.typeProject',
    time: '5 min ago',
    status: 'online',
  },
  {
