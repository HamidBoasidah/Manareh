          ...
          <div class="w-full max-w-md pt-10 mx-auto">
            <div class="flex items-center justify-between">
              <button
                ...
                :title="currentLocale === 'ar' ? t('switchToEnglish') : t('switchToArabic')"
              >
...
// Local page-scoped i18n messages without '@' symbols to avoid linked format parsing
const { t, locale } = useI18n({
  ...
  ar: {
      ...
      withGoogle: 'تسجيل الدخول باستخدام جوجل',
      withX: 'تسجيل الدخول باستخدام X',
      or: 'أو',
  ...
  emailPlaceholder: 'name.example.com',
      ...
      signUp: 'إنشاء حساب',
      tagline: 'قالب لوحة تحكم Tailwind CSS مجاني ومفتوح المصدر',
    },
  },
})
