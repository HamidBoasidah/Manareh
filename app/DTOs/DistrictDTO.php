...
class DistrictDTO extends BaseDTO
{
    ...
    public function __construct($id, $name_ar, $name_en, $is_active, $governorate_id, $governorate_name_ar = null, $governorate_name_en = null)
    {
        $this->id = $id;
    ...
    public function toArray(): array
    {
        return [
            ...
            // created_by/updated_by omitted from DTO
        ];
    }
