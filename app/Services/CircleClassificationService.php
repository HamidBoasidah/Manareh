...
use App\Repositories\CircleClassificationRepository;

class CircleClassificationService
{
    protected CircleClassificationRepository $items;

    public function __construct(CircleClassificationRepository $items)
    {
        $this->items = $items;
    }
